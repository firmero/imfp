function res = pvinterpolationenc(polynomial_coefficients,X)
%BEGINDOC==================================================================
% .Author
%
%  Roman Firment
...
p_at_c = pvhornerenc(polynomial_coefficients,intval(c));
p_derivated_at_c = pvhornerenc(p_derivated,intval(c));
